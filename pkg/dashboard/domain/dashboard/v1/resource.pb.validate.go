...
// Validate checks the field values on GetResourceRelationRequest with the
...
// ValidateAll checks the field values on GetResourceRelationRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetResourceRelationRequestMultiError, or nil if none found.
func (m *GetResourceRelationRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetResourceRelationRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetResourceRelationRequestMultiError(errors)
	}

	return nil
}

// GetResourceRelationRequestMultiError is an error wrapping multiple
// validation errors returned by GetResourceRelationRequest.ValidateAll() if
// the designated constraints aren't met.
type GetResourceRelationRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetResourceRelationRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetResourceRelationRequestMultiError) AllErrors() []error { return m }

// GetResourceRelationRequestValidationError is the validation error returned
// by GetResourceRelationRequest.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e GetResourceRelationRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetResourceRelationRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetResourceRelationRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetResourceRelationRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetResourceRelationRequestValidationError) ErrorName() string {
	return "GetResourceRelationRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetResourceRelationRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetResourceRelationRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetResourceRelationRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetResourceRelationRequestValidationError{}

// Validate checks the field values on GetResourceRelationResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on GetResourceRelationResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetResourceRelationResponseMultiError, or nil if none found.
func (m *GetResourceRelationResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetResourceRelationResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetResources() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetResourceRelationResponseValidationError{
						field:  fmt.Sprintf("Resources[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return GetResourceRelationResponseValidationError{
					field:  fmt.Sprintf("Resources[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetResourceRelationResponseMultiError(errors)
	}

	return nil
}

// GetResourceRelationResponseMultiError is an error wrapping multiple
// validation errors returned by GetResourceRelationResponse.ValidateAll() if
// the designated constraints aren't met.
type GetResourceRelationResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetResourceRelationResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetResourceRelationResponseMultiError) AllErrors() []error { return m }

// GetResourceRelationResponseValidationError is the validation error returned
// by GetResourceRelationResponse.Validate if the designated constraints
// aren't met.
...
// Field function returns field value.
func (e GetResourceRelationResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetResourceRelationResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetResourceRelationResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetResourceRelationResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetResourceRelationResponseValidationError) ErrorName() string {
	return "GetResourceRelationResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetResourceRelationResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetResourceRelationResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetResourceRelationResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetResourceRelationResponseValidationError{}
