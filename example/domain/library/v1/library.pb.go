...
import (
	v11 "github.com/amaury95/graphify/pkg/models/domain/collections/v1"
	v1 "github.com/amaury95/graphify/pkg/models/domain/utils/v1"
...
type Library struct {
	...
	Location *v1.Location `protobuf:"bytes,3,opt,name=location,proto3" json:"location,omitempty"`
	Country  v11.Country  `protobuf:"varint,4,opt,name=country,proto3,enum=collections.v1.Country" json:"country,omitempty"`
}
...
func (x *Library) GetLocation() *v1.Location {
	if x != nil {
		return x.Location
	}
	return nil
...
func (x *Library) GetCountry() v11.Country {
	if x != nil {
		return x.Country
	}
	return v11.Country(0)
}
...
var file_library_v1_library_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x12, 0x75, 0x74, 0x69, 0x6c, 0x73, 0x2f, 0x76, 0x31,
	0x2f, 0x67, 0x65, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x93, 0x01, 0x0a, 0x07, 0x4c,
	0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x12, 0x11, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x5f, 0x6b, 0x65, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	0x12, 0x2e, 0x75, 0x74, 0x69, 0x6c, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a,
	0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17,
	...
	0x42, 0xa9, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79,
	...
	0x61, 0x6d, 0x61, 0x75, 0x72, 0x79, 0x39, 0x35, 0x2f, 0x67, 0x72, 0x61, 0x70, 0x68, 0x69, 0x66,
	0x79, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e,
...
var file_library_v1_library_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_library_v1_library_proto_goTypes = []interface{}{
	(*Library)(nil),     // 0: library.v1.Library
	(*v1.Location)(nil), // 1: utils.v1.Location
	(v11.Country)(0),    // 2: collections.v1.Country
}
var file_library_v1_library_proto_depIdxs = []int32{
	1, // 0: library.v1.Library.location:type_name -> utils.v1.Location
...
func (*Library) Argument() graphql.FieldConfigArgument {
	return graphql.FieldConfigArgument{
		...
		"location": &graphql.ArgumentConfig{
			Type: v1.Location_Input,
		},
		"country": &graphql.ArgumentConfig{
			Type: v11.Country_Enum,
		},
	}
}
...
func (o *Library) UnmarshalMap(values map[string]interface{}) {
	...
	if val, ok := values["location"].(map[string]interface{}); ok {
		field := new(v1.Location)
		field.UnmarshalMap(val)
		o.Location = field
	}
	if val, ok := values["country"].(v11.Country); ok {
		o.Country = val
	}
	if val, ok := values["country"].(float64); ok {
		o.Country = v11.Country(val)
	}
}
